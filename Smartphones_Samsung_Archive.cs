...
{
    public partial class Smartphones_Samsung_Archive : MaterialForm
    {
        ...
        public Smartphones_Samsung_Archive()
        {
            InitializeComponent();
        ...
        private void Smartphones_Samsung_Archive_Load(object sender, EventArgs e)
        {
            int i, n;
            dataGridView1.Rows.Clear();
            string sql = "SELECT * FROM smartphones_samsung_archive";
        ...
        private void button22_Click(object sender, EventArgs e)
        {
            int i, n;
            string sql = "";
            sql = $"select * from smartphones_samsung_archive where receipt_date = '{dateTimePicker1.Value.Date.ToString("yyyy-MM-dd")}'";
            dataGridView1.Rows.Clear();
            myCommand.CommandText = sql;
            MySqlDataReader reader = myCommand.ExecuteReader();
        ...
        private void materialToolStripMenuItem52_Click(object sender, EventArgs e)
        {
            ...
            wordParag.Range.Text = $"[Архив] Смартфоны Samsung";
            ...
            wordParag.Range.Font.Bold = 1;
            wordParag.Range.Text = $"Информация о архиве смартфонов Samsung";
