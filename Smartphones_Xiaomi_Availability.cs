...
{
    public partial class Smartphones_Xiaomi_Availability : MaterialForm
    {
        ...
        public Smartphones_Xiaomi_Availability()
        {
            InitializeComponent();
        ...
        private void Smartphones_Xiaomi_Availability_Load(object sender, EventArgs e)
        {
            int i, n;
            dataGridView1.Rows.Clear();
            string sql = "SELECT * FROM smartphones_xiaomi_warehouse order by model,price";
        ...
        private void Add_Click(object sender, EventArgs e)
        {
            ...
            myCommand.CommandText = $"select count(*) from smartphones_xiaomi_warehouse where model = '{model}' and class = '{class1}' and price = {price} and cpu = '{cpu}' and display = '{display}' and dram = {dram} and memory = {memory} and battery = {battery} and color = '{color}'";
            ...
            if (cnt != 0)
            {
                ...
                myCommand.CommandText = $"select quantity from smartphones_xiaomi_warehouse where model = '{model}' and class = '{class1}' and price = {price} and cpu = '{cpu}' and display = '{display}' and dram = {dram} and memory = {memory} and battery = {battery} and color = '{color}'";
        ...
        private void materialToolStripMenuItem40_Click(object sender, EventArgs e)
        {
            ...
            wordParag.Range.Text = $"Смартфоны Xiaomi";
