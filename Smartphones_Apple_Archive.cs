...
{
    public partial class Smartphones_Apple_Archive : MaterialForm
    {
        ...
        public Smartphones_Apple_Archive()
        {
            InitializeComponent();
        ...
        private void Smartphones_Apple_Archive_Load(object sender, EventArgs e)
        {
            int i, n;
            dataGridView1.Rows.Clear();
            string sql = "SELECT * FROM smartphones_apple_archive";
        ...
        private void button22_Click(object sender, EventArgs e)
        {
            int i, n;
            string sql = "";
            sql = $"select * from smartphones_apple_archive where receipt_date = '{dateTimePicker1.Value.Date.ToString("yyyy-MM-dd")}'";
            dataGridView1.Rows.Clear();
            myCommand.CommandText = sql;
            MySqlDataReader reader = myCommand.ExecuteReader();
        ...
        private void materialToolStripMenuItem52_Click(object sender, EventArgs e)
        {
            ...
            wordParag.Range.Text = $"[Архив] Смартфоны Apple";
            ...
            wordParag.Range.Font.Bold = 1;
            wordParag.Range.Text = $"Информация о архиве смартфонов Apple";
