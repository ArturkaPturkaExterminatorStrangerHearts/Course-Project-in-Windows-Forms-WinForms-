...
{
    public partial class Staff_Add : MaterialForm
    {
        ...
        private void Add_Click(object sender, EventArgs e)
        {
            ...
            myCommand.CommandText = $"insert into staff(fullname,job,city,salary,phone,datebirth) values('{textBox1.Text}','{textBox3.Text}','{textBox4.Text}',{textBox5.Text},{textBox6.Text},'{dateTimePicker1.Value.Date.ToString("yyyy-MM-dd")}')";
