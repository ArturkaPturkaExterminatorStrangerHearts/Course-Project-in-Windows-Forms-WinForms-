...
{
    public partial class Smartphones_Archive : MaterialForm
    {
        ...
        private void Smartphones_Archive_Load(object sender, EventArgs e)
        {
            int i, n;
            dataGridView1.Rows.Clear();
            string sql = "SELECT * FROM smartphones_archive";
            ...
            while (reader.Read())
            {
                ...
                for (i = 0; i < 12; i++)
                    ...
                    dataGridView1.Rows[n].Cells[12].Value = (DateTime)reader[12];
            }
        ...
        private void button22_Click(object sender, EventArgs e)
        {
            int i, n;
            string sql = "";
            sql = $"select * from smartphones_archive where receipt_date = '{dateTimePicker1.Value.Date.ToString("yyyy-MM-dd")}'";
            dataGridView1.Rows.Clear();
            myCommand.CommandText = sql;
            MySqlDataReader reader = myCommand.ExecuteReader();
        ...
        private void materialToolStripMenuItem52_Click(object sender, EventArgs e)
        {
            ...
            wordParag.Range.Text = $"[Архив] Все смартфоны";
            ...
            wordParag.Range.Font.Bold = 1;
            wordParag.Range.Text = $"Информация о архиве всех смартфонов";
